...
PUSH_SWAP_SRC = indexing.c parse.c push_swap.c sort_large.c sort_small.c stack_utils2.c sort_utils.c stack_operations.c stack_operations2.c stack_rotations.c stack_rotations2.c stack_utils.c stack.c utilities.c
